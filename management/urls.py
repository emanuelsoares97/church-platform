...
urlpatterns = [
    ...
    path("galeria/albuns/<slug:slug>/ativar/", views.activate_gallery_album, name="gallery_album_activate"),
    path("galeria/albuns/<slug:slug>/desativar/", views.deactivate_gallery_album, name="gallery_album_deactivate"),
    path("galeria/albuns/<slug:slug>/editar/", views.edit_gallery_album, name="gallery_album_edit"),
    path("galeria/albuns/<slug:slug>/eliminar/", views.delete_gallery_album, name="gallery_album_delete"),
